    ...
    <div className="relative overflow-hidden bg-dark text-foreground min-h-screen">
      ...
      <section className="py-20 md:py-28 max-w-7xl mx-auto px-4">
        ...
        <div className="relative flex flex-col items-center max-w-md mx-auto space-y-16">
          ...
          <div className="flex flex-col items-center bg-card border border-border/60 rounded-xl p-8 shadow-md w-3/5 text-center animate-fadeInUp delay-200">
          ...
          {/* Step 2 (Middle) */}
          <div className="flex flex-col items-center bg-card border border-border/60 rounded-xl p-8 shadow-md w-4/5 text-center animate-fadeInUp delay-400">
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary text-primary-foreground text-3xl font-extrabold mb-4 border-4 border-primary shadow-lg">
              2
            </div>
          ...
          {/* Step 1 (Base) */}
          <div className="flex flex-col items-center bg-card border border-border/60 rounded-xl p-8 shadow-md w-full text-center animate-fadeInUp delay-600">
            <div className="flex items-center justify-center w-16 h-16 rounded-full bg-primary text-primary-foreground text-3xl font-extrabold mb-4 border-4 border-primary shadow-lg">
              1
            </div>

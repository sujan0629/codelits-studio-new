...
const clients = [
  {
    name: 'Meta',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fb/Meta_Logo_2022.svg', // clean white Meta logo
  },
  {
    name: 'Apple',
  ...
  },
  {
    ...
    logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Microsoft_logo_-_white.svg', // white Microsoft logo for dark bg
  },
  {
    name: 'Twitter (X)',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/X_Logo.svg', // X logo (white)
  },
  {
    name: 'IBM',

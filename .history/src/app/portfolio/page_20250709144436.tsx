...
export default function PortfolioShowcase() {
  ...
  useEffect(() => {
    ...
    // Set initial styles and hide all projects except first
    gsap.set(wrappers, {
      position: 'absolute',
      top: 0,
      left: 0,
    ...
    wrappers.forEach((wrapper, i) => {
      ...
      const startTime = (i - 1) * 1.5; // adjust timing as needed

      // Outgoing project spins 2 full rotations on X and fades out
      tl.to(
        wrappers[i - 1],
        {
          autoAlpha: 0,
      ...
      // Incoming project spins in from 360deg to 0deg and fades in
      tl.fromTo(
        wrappers[i],
        {
          autoAlpha: 0,

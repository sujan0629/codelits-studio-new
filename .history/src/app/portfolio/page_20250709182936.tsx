...
const PortfolioPage = () => {
  ...
  style={{ backgroundColor: '#0F1011', maxWidth: '500px', minHeight: '280px' }}
>
  <div className="relative z-10 flex flex-col h-full p-8 justify-between">
    <div>
      {/* Glowing colored points and lines instead of icon */}
      <div className="mb-6 flex items-center justify-start gap-2">
        <span className="h-3 w-3 rounded-full bg-yellow-400 shadow-[0_0_8px_2px_rgba(255,230,100,0.8)]"></span>
        <span className="h-3 w-3 rounded-full bg-cyan-400 shadow-[0_0_6px_2px_rgba(100,230,255,0.7)]"></span>
        <span className="h-10 w-[2px] rounded bg-pink-500 shadow-[0_0_10px_2px_rgba(255,100,180,0.8)]"></span>
      </div>

      <h3 className="font-headline text-2xl font-bold text-white max-w-md">{portfolioCategories[0].title}</h3>

      <p className="mt-2 text-muted-foreground max-w-md">{portfolioCategories[0].description}</p>
    </div>
    <div className="mt-8 flex items-center gap-2 font-medium text-primary max-w-md">

...
import { ArrowRight, Briefcase, FlaskConical, Handshake, Trophy } from 'lucide-react';
  ...
  },
{
  ...
  icon: Trophy,  // (assuming you want to change icon from PenTool to Trophy or similar)

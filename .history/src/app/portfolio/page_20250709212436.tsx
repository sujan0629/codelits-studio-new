...
const CardBackground = ({
  ...
  if (Bg) {
    return (
      <div className="absolute mt-10 ml-96 inset-0 pointer-events-none opacity-50">
        <Bg />
      </div>
    );
  }
  ...
  if (image) {
    return (
      <NextImage
        ...
        alt={title}
        fill
        className="absolute inset-0 object-cover mb-40 opacity-10 group-hover:opacity-20 transition-opacity duration-500"
      />
    );
  }
...
const portfolioCategories = [
  ...
  },
  {
    ...
    description:
      'Our experiments and internal projects where we explore new technologies and push creative boundaries. Our experiments and internal projects where we explore new technologies and push creative boundaries. Our experiments and internal projects.',
        ...
        <div className="grid grid-cols-1 max-w-[1300px] mx-auto gap-8" ref={cardsRef}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            >
              ...
              <div className="absolute mt-6 ml-56 inset-0 pointer-events-none opacity-50">
                <GraphWithSnakeTail />
              </div>
            </Link>
          </div>

...
const portfolioCategories = [
  ...
  },
  {
    ...
    description:
      'Our experiments and internal projects where we explore new technologies and push creative boundaries. Our experiments and internal projects where we explore new technologies and push creative boundariesOur experiments and internal projects where we explore new technologies and push creative boundaries',
    href: '/portfolio/research',
    icon: FlaskConical,
    className: 'h-96',
        bgComponent: AnimatedAtom,   
  },
  {
                  ...
                  <Button asChild size="lg" variant="outline">
                    <Link href="/">
                      Explore Section <ArrowRight className="ml-2" />
                        ...
                        <div className="absolute ml-80 inset-0 opacity-50 pointer-events-none">
      {/* after the card’s text/buttons … */}
{item.bgComponent && (
  <div className="absolute inset-0 opacity-50 pointer-events-none">
    {React.createElement(item.bgComponent)}
  </div>
)}
</div>
              </Link>
                  ...
                  <Button asChild size="lg" variant="outline">
                    <Link href="/">
                      Explore Section <ArrowRight className="ml-2" />
                            ...
                            <div className="absolute mt-10 inset-0 opacity-50 pointer-events-none">
              <AnimatedAtom />
              </div>

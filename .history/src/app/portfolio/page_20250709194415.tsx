...
const portfolioCategories = [
  {
    title: 'Client Work',
    description:
      "Explore our successful collaborations and the impactful solutions we've delivered for our clients.Explore our successful collaborations and the impactful solutions we've delivered for our clients.",
    ...
    <div className="relative min-h-screen w-full overflow-hidden" ref={sectionRef}>
      <div className="container relative mx-auto px-4 py-16 md:py-24">
        ...
        <div className="mt-8 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 max-w-[1300px] lg:grid-cols-2">
            <Link

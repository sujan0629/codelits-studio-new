...
<div className="relative my-16">
  {/* Grid pattern positioned absolutely, larger than widget */}
  <GridPattern
    width={40}
    height={40}
    x={-2}
    y={-2}
    className="pointer-events-none absolute -inset-12 stroke-primary/10 opacity-20"
  />
  
  {/* Trustpilot widget above the grid */}

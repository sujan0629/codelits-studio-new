...
>
  {allProjects.map((project) => (
    <div
      key={project.slug}
      className="project-wrapper w-[95vw] max-w-7xl flex flex-col md:flex-row items-center md:items-start gap-10"
    >
      ...
      <div className="project-details w-full md:flex-1 flex flex-col justify-center text-center md:text-left">

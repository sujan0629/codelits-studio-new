...
export default function ProjectDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Info bar */}
      <div className="sticky top-0 z-20 border-b bg-background backdrop-blur-md px-4 py-6 md:px-8 md:py-8">
        ...
        {canBeIframed ? (
          <>
            ...
            <iframe
              ...
              title={project.title}
              className={cn(
                'flex-grow w-full min-h-0 border-0 transition-opacity duration-500',

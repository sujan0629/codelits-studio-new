...
export default function PortfolioShowcase() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      wrappers.forEach((wrapper, i) => {
        ...
        tl.to(wrappers[i], { autoAlpha: 1, duration: 1, ease: 'power1.inOut' }, (i - 1) * 1.5);
      });
    }, containerRef);
  ...
  return (
    <>
      {/* This div creates scroll space, so page scroll bar exists but page content stays pinned */}
      <div
        ref={scrollProxyRef}

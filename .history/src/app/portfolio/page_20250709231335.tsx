...
<div className="relative w-full my-20 min-h-[300px]"> {/* adjust min-h as needed */}
  <GridPattern
    width={100}   // increase width and height to cover more grid cells
    height={100}
    x={-1}
    y={-1}
    className="pointer-events-none absolute inset-0 stroke-primary/10 opacity-20"
  />

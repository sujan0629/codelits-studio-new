...
<div className="relative max-w-lg mx-auto p-8 rounded-2xl bg-white shadow-lg overflow-hidden">
  <GridPattern
    width={40}
    height={40}
    className="absolute inset-0 -z-10 stroke-primary/10 opacity-30"
    aria-hidden="true"
  />
  <TrustpilotWidget />
</div>

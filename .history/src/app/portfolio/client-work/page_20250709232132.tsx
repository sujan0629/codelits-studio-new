...
export default function ClientWorkPage() {
  ...
  return (
    <div ref={containerRef} className="portfolio-showcase-container bg-background">
      <div className="text-center max-w-3xl mx-auto py-6 md:py-24 px-4">
      ...
      <div className="relative">
        {clientProjects.map((project, index) => {
          return (
            <section 
              key={project.slug} 
              className="project-section relative min-h-screen w-full flex items-center justify-center p-4 sm:p-8 md:p-12 overflow-hidden"

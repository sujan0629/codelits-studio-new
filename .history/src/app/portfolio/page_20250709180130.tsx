      ...
      <div className="container relative mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {portfolioCategories.map((item, index) => (
            <Link href={item.href} key={index} className={`category-card group relative rounded-2xl overflow-hidden border bg-card/40 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-primary/30 ${item.className}`}>

...
const portfolioCategories = [
  {
    title: 'Client Work',
    description: 'Explore our successful collaborations and the impactful solutions we\'ve delivered for our clients.Explore our successful collaborations and the impactful solutions we\'ve delivered for our clients.',
...
const PortfolioPage = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Create a timeline for all cards with stagger
      const tl = gsap.timeline({
        scrollTrigger: {
          trigger: sectionRef.current,
          start: "top 85%", // when section top hits 85% viewport height
      ...
      tl.fromTo(
        cards,
        { y: 50, opacity: 0 },
        { y: 0, opacity: 1, stagger: 0.2, ease: 'power4.out', duration: 1.2 }
      );
    }, sectionRef);
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden" ref={sectionRef}>
      ...
      <div className="container relative mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1  max-w-[1300px] mx-auto gap-8">
          {/* Row 1: Long Card */}
  ...
  <div className="max-w-[400px]">
    ...
    <div className="mt-8 flex items-center gap-2">
     <Button asChild size="lg" variant="outline">
                        <Link href="/">Explore Section <ArrowRight className="ml-2" /></Link>
                    </Button>
    </div>
  </div>

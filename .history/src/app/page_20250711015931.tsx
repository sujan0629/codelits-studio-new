...
function ProductDirection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(".direction-label", { y: 20, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 })
        ...
        .fromTo(".direction-image-container", 
          { y: 100, opacity: 0, scale: 0.9, rotationX: -20, rotationZ: -5 }, 
          { y: 0, opacity: 1, scale: 1, rotationX: 0, rotationZ: 0, duration: 1.5, ease: 'elastic.out(1, 0.75)' }, 
          "-=1.2"
        );
  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-32 overflow-visible bg-background">
      <div className="container mx-auto px-4 z-10 relative text-center">
      ...
      <div className="direction-image-container mt-20 md:mt-24 relative w-full max-w-full overflow-visible perspective-1000">
        ...
        >
          {/* Wrapper with border radius but overflow visible */}
          <div
            style={{
              borderRadius: '1rem',
              overflow: 'visible',

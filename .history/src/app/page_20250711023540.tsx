...
function FeaturedWork() {
    ...
    return (
        <section ref={sectionRef} id="work" className="py-20 md:py-28 bg-background relative overflow-hidden">
          ...
          <span>Showcasing excellence through innovation</span>
        </div>
        ...
        <section ref={sectionRef} className="py-20 md:py-28 bg-card/50">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                          ...
                          <div className="direction-label inline-flex items-center mt-10 gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
          <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>

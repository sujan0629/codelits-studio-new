...
const title = [
  ...
  We&rsquo;re CodeLits Studio — a full-stack software company turning ambitious ideas into powerful tech solutions across web, mobile, AI, and beyond.
        ...
        <div className="hero-image mt-24 relative max-w-5xl mx-auto aspect-[12/8] group overflow-hidden">
  <div className="absolute inset-0 rounded-2xl transform-gpu transition-all duration-500 group-hover:scale-[1.02] group-hover:-translate-y-2 z-10" />
  <Image
    src="/images/hero1.png"
    alt="Digital masterpiece"
    width={1200}
    height={600}
    className="rounded-xl shadow-2xl w-full h-full object-cover object-top transform-gpu transition-transform duration-500 group-hover:scale-105 scale-x-[1.15]"

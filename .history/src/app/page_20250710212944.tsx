...
<section ref={heroRef} className="relative py-20 md:py-32 overflow-hidden bg-background">
  ...
  <div className="container mx-auto px-4 z-10 relative text-center">
   ...
   <div className="relative mt-24 max-w-5xl mx-auto w-full perspective-1000" style={{ perspective: 1000 }}>
  <div className="relative w-full h-[400px]">
    {/* First image - bottom "page" */}
    <div
      className="absolute left-1/2 top-0 w-full max-w-4xl rounded-xl shadow-2xl overflow-hidden -translate-x-1/2"
      style={{
    ...
    {/* Second image - top "page", slightly overlapping above the first */}
    <div
      className="absolute left-1/2 top-[140px] w-full max-w-4xl rounded-xl shadow-2xl overflow-hidden -translate-x-1/2"
      style={{
        transform: "rotateX(15deg)",
        transformOrigin: "center bottom",
    ...
    >
      <Image
        ...
        alt="Second digital masterpiece"
        width={1200}
        height={600}
        className="w-full h-full object-cover object-top"
        priority

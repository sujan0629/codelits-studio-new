...
export default function ServiceDetailPage() {
  ...
  return (
    <div className="bg-background text-foreground">
      {/* Hero */}
      <div className="relative pt-6 md:pt-10 pb-16 md:pb-20 overflow-hidden">
        <GridPattern
          width={60}
          height={60}
          x={-1}
  ...
  {/* Back to Services button on top */}
<div>
  ...
  {/* Service Icon below the button */}
  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 text-primary animate-fade-in">

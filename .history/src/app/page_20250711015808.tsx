...
function ProductDirection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(".direction-label", { y: 20, opacity: 0 }, { y: 0, opacity: 1, duration: 0.8 })
        ...
        .fromTo(".direction-image-container", { y: 100, opacity: 0, scale: 0.9, rotationX: -20, rotationZ: -5 }, { y: 0, opacity: 1, scale: 1, rotationX: 0, rotationZ: 0, duration: 1.5, ease: 'elastic.out(1, 0.75)' }, "-=1.2");
  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-32 overflow-hidden bg-background">
      ...
      <div className="direction-image-container mt-20 md:mt-24 relative w-full max-w-full overflow-visible perspective-1000">
  <div
    className="relative mx-auto rounded-2xl"
    style={{
      width: '100vw',  // full viewport width
      maxWidth: '100vw',
      aspectRatio: '12 / 4', // keep ratio
      transformStyle: 'preserve-3d',
      transform: 'rotateX(-45deg) rotateZ(-10deg)',
      filter: 'drop-shadow(0 0 0 transparent)', // no glow
      overflow: 'visible',
    }}
  >
    <Image
      src="/images/bugattii.jpg"
    ...
    />
    {/* Left side subtle black blur */}
<div
  aria-hidden="true"
  className="pointer-events-none absolute top-0 left-0 h-full"
  style={{
    width: '6vw', // a bit wider for smoother blur
    background: 'linear-gradient(to right, rgba(0,0,0,0.5), transparent)',
    filter: 'blur(16px)', // stronger blur
    borderRadius: '1rem 0 0 1rem',
    zIndex: 10,
    pointerEvents: 'none',
    marginLeft: '-6vw', // move it outside the image so it doesn't clip left edge
  }}
/>
<div
  aria-hidden="true"
  ...
  style={{
    ...
    zIndex: 10,
    pointerEvents: 'none',
    marginRight: '-6vw', // outside right edge
  }}
/>
<div
  aria-hidden="true"
  ...
  style={{
    ...
    zIndex: 10,
    pointerEvents: 'none',
    marginTop: '-3vh', // outside top edge
  }}
/>
<div
  aria-hidden="true"
  ...
  style={{
    ...
    zIndex: 10,
    pointerEvents: 'none',
    marginBottom: '-3vh', // outside bottom edge
  }}
/>

      ...
      <section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative ">
        ...
        <div className="relative w-full max-w-md mx-auto aspect-square">
          ...
          >
            <path
                     ref={trianglePathRef}
              d="M 100 20 L 10 170 L 200 170 Z"
          ...
          {/* Step 1: Top */}
          <div
            className="absolute top-2 left-1/2 transform -translate-x-1/2 w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
        ...
        {/* Step 2: Bottom left */}
<div
  className="absolute bottom-10 left-[100%]  w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <Check className="w-6 h-6 text-primary" />
  <span className="text-white font-semibold text-sm">Generate</span>
</div>

{/* Step 3: Bottom right */}
<div
  className="absolute bottom-10 right-[100%] w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <Check className="w-6 h-6 text-primary" />
  <span className="text-white font-semibold text-sm">Refine & Use</span>
</div>

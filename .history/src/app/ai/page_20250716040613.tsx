    ...
    <div className="relative overflow-hidden bg-dark text-foreground min-h-screen">
      ...
      <section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative">
        ...
        <div className="relative w-full max-w-md mx-auto aspect-square">
         ...
         {/* Triangle base with extra horizontal dotted lines */}
<svg
  className="absolute inset-0 w-full h-full"
  viewBox="0 0 280 200"  // wider viewbox for extra horizontal space
  fill="none"
...
>
  ...
  <path
    ref={trianglePathRef}
    d="M 140 20 L 80 170 L 200 170 Z"
    stroke="rgba(255,255,255,0.3)"
    strokeWidth="1"
    strokeDasharray="6 6"
  />

  {/* Horizontal dotted lines from bottom corners */}
  <path
    d="M 80 170 L 10 170" // left horizontal line
    stroke="rgba(255,255,255,0.3)"
    strokeWidth="1"
    strokeDasharray="6 6"
  />
  <path
    d="M 200 170 L 270 170" // right horizontal line
    stroke="rgba(255,255,255,0.3)"
    strokeWidth="1"
    strokeDasharray="6 6"
  />
        ...
        {/* Step 2: Bottom left */}
<div
  className="absolute bottom-4 left-[120%] bg-white bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <CheckCircle className="w-6 h-6 text-primary" />
  <span className="text-white font-semibold text-lg">Generate Content</span>
</div>

{/* Step 3: Bottom right */}
<div
  className="absolute bottom-4 right-[120%] bg-white bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <CheckCircle className="w-6 h-6 text-primary" />

  ...
  return (
    <div className="relative overflow-hidden bg-dark text-foreground min-h-screen">
      ...
      <section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative">
        ...
        {/* Step 2: Bottom left */}
<div
  className="absolute bottom-4 left-[100%] bg-white bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <CheckCircle className="w-6 h-6 text-primary" />
...
{/* Step 3: Bottom right */}
<div
  className="absolute bottom-4 right-[100%] bg-white bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <CheckCircle className="w-6 h-6 text-primary" />

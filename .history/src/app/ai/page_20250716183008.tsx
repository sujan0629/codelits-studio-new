...
export default function AiLandingPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-dark text-foreground min-h-screen ">
      {/* Hero Section */}
      <section className="relative bg-dark w-full py-14 md:py-32 overflow-hidden">
        <GridPattern
          width={50}
          height={50}
          x={-1}
...
<section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative">
  ...
  <div className="relative w-full max-w-[300px] sm:max-w-[400px] md:max-w-md mx-auto aspect-square">
    {/* Triangle SVG */}
    <svg
    ...
    {/* Step 1: Top */}
    <div
      className="absolute top-[5%] left-1/2 -translate-x-1/2 w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
    >
      <Check className="w-5 h-5 text-primary" />
      <span className="text-white text-sm font-semibold">Input Details</span>
    </div>

    {/* Step 2: Bottom Left */}
    <div
      className="absolute bottom-[10%] left-[10%] sm:left-[5%] w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
    >
      <Check className="w-5 h-5 text-primary" />
    ...
    {/* Step 3: Bottom Right */}
    <div
      className="absolute bottom-[10%] right-[10%] sm:right-[5%] w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
    >
      <Check className="w-5 h-5 text-primary" />
      <span className="text-white text-sm font-semibold">Refine & Use</span>
    </div>
  </div>
</section>

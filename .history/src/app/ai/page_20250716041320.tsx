    ...
    <div className="relative overflow-hidden bg-dark text-foreground min-h-screen">
      ...
      <section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative">
        ...
        <div className="relative w-full max-w-md mx-auto aspect-square">
          ...
          {/* Step 1: Top */}
          <div
            className="absolute top-2 left-1/2 transform -translate-x-1/2 bg-transparent bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48 mx-auto"
...
{/* Step 3: Bottom right */}
<div
  className="absolute bottom-10 right-[100%] bg-transparent bg-opacity-10 border border-primary border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <Check className="w-6 h-6 text-primary" />

...
const steps = [
  { id: 1, name: 'Input Details' },
  { id: 2, name: 'Generate Content' },
  { id: 3, name: 'Refine & Use' },
];
const comingSoon = [
...
export default function AiLandingPage() {
 ...
 <section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative">
      ...
      <div className="relative w-full max-w-md mx-auto aspect-square">
        ...
        {/* Step 2: Bottom left */}
        <div
          className="absolute bottom-4 left-4 bg-white bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
          style={{ backdropFilter: 'blur(8px)' }}
        >
          <CheckCircle className="w-6 h-6 text-primary" />
        ...
        {/* Step 3: Bottom right */}
        <div
          className="absolute bottom-4 right-4 bg-white bg-opacity-10 border border-white border-opacity-30 rounded-md px-6 py-3 flex items-center gap-2 w-48"
          style={{ backdropFilter: 'blur(8px)' }}
        >
          <CheckCircle className="w-6 h-6 text-primary" />

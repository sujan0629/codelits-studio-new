...
export default function AiLandingPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-background text-foreground">
      ...
      {/* Hero */}
      <section ref={(el) => el && sectionsRef.current.push(el)} className="container mx-auto px-6 py-24 md:py-32 grid md:grid-cols-2 items-center gap-16">
        <div>
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-lg">
            Use our AI toolkit to write better content, generate ideas, and refine your message—all in one place.
          </p>
          <div className="mt-8">
        ...
        <div className="aspect-square w-full max-w-md mx-auto">
          <svg
            ...
            strokeWidth="2.5"
          >
            <circle cx="128" cy="128" r="90" fill="hsl(var(--primary) / 0.05)" />
            <path
      ...
      {/* Features */}
      <section ref={(el) => el && sectionsRef.current.push(el)} className="py-20 md:py-28 bg-card/30">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center font-headline">AI Features That Do the Work for You</h2>
          <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {features.map((feature, idx) => (
              <div key={idx} className="bg-card rounded-xl p-6 border border-border text-center shadow-sm">
      ...
      {/* Benefits */}
      <section ref={(el) => el && sectionsRef.current.push(el)} className="py-20 md:py-28">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold font-headline mb-6">Smarter Workflow, Better Results</h2>
              <p className="text-lg text-muted-foreground">
                Let the AI handle repetitive tasks while you focus on creative storytelling.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* CTA */}
      <section ref={(el) => el && sectionsRef.current.push(el)} className="py-20 md:py-28 text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          <h2 className="text-3xl md:text-4xl font-bold font-headline">Supercharge Your Creativity</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Stop wasting time on the blank page. Start creating better content with AI.
          </p>
          <div className="mt-8">
            <Button asChild size="lg">
              <Link href="/admin">

  ...
  return (
    <div>
      <div className="mb-8 max-w-3xl">
        <h1 className="font-headline text-2xl mx-14 md:text-2xl font-bold tracking-tight">
          Welcome to the AI Toolkit
        </h1>
        <p className="mt-2 mx-14 text-sm text-muted-foreground max-w-xl">
          Select a tool below to get started. More tools are coming soon!
        </p>
      </div>
<div className="grid grid-cols-1 sm:grid-cols-2 gap-14 max-w-7xl mx-auto pl-0 pr-0">
        {tools.map((tool) => (

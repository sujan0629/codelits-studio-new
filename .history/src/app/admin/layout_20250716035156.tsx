    ...
    <TooltipProvider>
      <div className="flex min-h-screen w-full bg-muted/40">
        ...
        <div className="flex flex-1 flex-col">
          <header className=" top-0 z-10 flex h-14 items-center justify-between border-b bg-background px-6 sm:h-auto sm:border-0 sm:bg-transparent sm:py-4">
  <Link href="/ai">   <div className="flex items-center gap-3">

...
>
        ...
        <div className="flex flex-1 flex-col">
          ...
          <button
  // ...
  className="sm:hidden flex items-center justify-center rounded-md p-2 text-muted-foreground hover:bg-muted/30 focus:outline-none"
  // add focus:outline-none to remove the default outline
>

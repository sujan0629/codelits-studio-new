  ...
  const cardContent = (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="opacity-10 group-hover:opacity-20 transition-opacity duration-500">
          <defs>
      ...
      <div className="relative z-10">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/15 border border-primary/30 text-primary flex-shrink-0">
            <tool.icon className="h-6 w-6" />
          </div>
          <div>
            <h3 className="font-headline text-lg font-semibold leading-tight">{tool.title}</h3>
      ...
      <div className="relative z-10 mt-6 flex items-center justify-end">
        <div
          className={cn(
            'flex items-center gap-2 text-sm font-medium transition-colors duration-300 select-none',

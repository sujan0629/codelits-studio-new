...
<div className="hero-image mt-24 relative max-w-[1150px] mx-auto aspect-[20/7.7] group
    rounded-xl border border-gray-700 shadow-lg bg-background">
  
  {/* Window controls bar */}
  <div className="absolute top-2 left-4 flex space-x-2 z-20">
  ...
  <div className="absolute inset-0 rounded-2xl transform-gpu transition-all duration-500 group-hover:scale-[1.02] group-hover:-translate-y-2" />
  ...
  {/* Black overlay */}
  <div className="absolute inset-0 rounded-xl bg-black opacity-50 pointer-events-none" />
</div>

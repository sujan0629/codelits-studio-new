...
<section ref={heroRef} className="relative py-20 md:py-32 overflow-hidden bg-background">
  ...
  <div className="container mx-auto px-4 z-10 relative text-center">
    ...
    {/* Container for two tilted images stacked vertically */}
    <div className="relative mt-24 max-w-5xl mx-auto w-full perspective-1000">
      <div className="relative w-full flex flex-col items-center space-y-6"
           style={{
             transformStyle: "preserve-3d",
             transformOrigin: "center center",
           }}>
        {/* First image tilted slightly */}
        <div
          className="w-full rounded-xl shadow-2xl overflow-hidden"
          style={{
            transform: "rotateX(15deg)",
            transformOrigin: "center bottom",
            boxShadow: "0 20px 30px rgb(0 0 0 / 0.2)"
          }}
        >
          <Image

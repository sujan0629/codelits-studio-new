...
<div className="hero-image mt-24 relative max-w-[1150px] mx-auto group">
  {/* Outer container with border and shadow */}
  <div className="rounded-xl border border-gray-700 shadow-lg overflow-hidden bg-background">
    {/* Top nav bar */}
    <div className="flex items-center gap-2 px-4 h-8 border-yellow-700 rounded-t-xl">
    ...
    {/* Content area with the GIF */}
    <div className="relative aspect-[20/7.7]">
      <Image
        src="/images/hehe.gif"
        alt="Digital masterpiece"
        fill
        className="rounded-b-xl object-cover object-top filter brightness-50"
        data-ai-hint="digital agency dashboard"
      />

      {/* Black overlay */}
      <div className="absolute inset-0 rounded-b-xl bg-black opacity-50 pointer-events-none" />
    </div>
  </div>
</div>
</div>

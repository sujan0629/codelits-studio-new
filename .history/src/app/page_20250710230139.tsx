...
const title = [
  ...
  We&rsquo;re CodeLits Studio — a full-stack software company turning ambitious ideas into powerful tech solutions across web, mobile, AI, and beyond.
   ...
   <div className="hero-image mt-24 relative max-w-[1200px] mx-auto aspect-[20/11.5] group">
  ...
  {/* Black overlay */}
  <div className="absolute inset-0 rounded-xl bg-black opacity-40 pointer-events-none" />
</div>

...
function ProductDirection() {
  ...
  return (
    <section className="w-full min-h-screen bg-[#0F1011] flex flex-col justify-center items-center px-6 py-16">
      ...
      {/* Blurred container with the tilted image inside */}
      <div className="relative w-full max-w-6xl p-6 rounded-2xl bg-[#1a1a1a]/70 backdrop-blur-xl border border-[#2c2c2c] shadow-2xl">
        <div
          ref={imageRef}
          className="relative overflow-hidden rounded-xl transform shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-[#2a2a2a] bg-[#121212]/60 backdrop-blur-xl"

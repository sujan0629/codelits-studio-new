...
function Hero() {
  ...
  {/* Change bg-primary/10 (likely dark) to a lighter color or add opacity */}
  <div className="absolute inset-0 rounded-2xl bg-white/20 backdrop-blur-sm transform-gpu transition-all duration-500 group-hover:scale-[1.02] group-hover:-translate-y-2" />
  <Image

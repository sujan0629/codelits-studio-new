...
const features: Feature[] = [
  {
    ...
    imgSrc: 'https://placehold.co/800x600?text=Project+Management',
  ...
  },
  {
    ...
    imgSrc: 'https://placehold.co/800x600?text=Monitoring+and+Maintenance',
  ...
  },
  {
    ...
    imgSrc: 'https://placehold.co/800x600?text=UX+and+UI+Design',
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent pointer-events-none" />
        ...
        <div className="feature grid grid-cols-1 md:grid-cols-2 gap-8 items-start py-12">
          <div className="space-y-4 text-left">
            <h3 className="text-xl font-bold">{features[2].title}</h3>

...
const TestimonialCard = ({ testimonial }: { testimonial: typeof testimonials[0] }) => {
    ...
    return (
        <div
            ref={cardRef}
            className="relative p-8 rounded-lg bg-white text-black shadow-lg flex-shrink-0 w-[340px] md:w-[420px] h-[360px] flex flex-col justify-between border border-border cursor-grab"
            style={{ transformStyle: 'preserve-3d' }}
            onMouseMove={handleMouseMove}
            onMouseLeave={handleMouseLeave}
            // Change cursor to grabbing while dragging, handled externally on scroll container
        >
            {/* Big black quote mark above text */}
            <div>
                <span className="text-6xl font-bold leading-none select-none">
                    &quot;
                </span>
            </div>

            <p className="mt-2 text-base italic font-light leading-relaxed text-black text-left">
                {testimonial.quote}
            </p>

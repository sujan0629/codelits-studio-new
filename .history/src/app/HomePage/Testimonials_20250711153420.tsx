...
const TestimonialCard = ({ testimonial }: { testimonial: typeof testimonials[0] }) => {
    ...
    return (
        <div
            ref={cardRef}
            className="relative p-8 rounded-lg bg-white text-black shadow-lg flex-shrink-0 w-[550px] md:w-[590px] h-[360px] flex flex-col justify-between border border-border cursor-grab"
   ...
   <Quote
  className="w-10 h-10 text-red-600"  // Tailwind's red color
  fill="currentColor"  // fills icon with current text color (red)
  stroke="none"        // removes stroke for full fill
/>

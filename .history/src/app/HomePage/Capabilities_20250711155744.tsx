    ...
    >
      <div className="mx-auto max-w-5xl px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
          ...
          {/* Vertical divider */}
          <div className="hidden md:block absolute inset-y-0 left-1/2 w-1 bg-gray-600 transform -translate-x-1/2"></div>
        ...
        {/* Horizontal divider */}
        <div className="w-full h-1 bg-gray-600 relative">
          {/* Extend vertical divider through horizontal */}
          <div className="hidden md:block absolute top-0 left-1/2 h-full w-1 bg-gray-600 transform -translate-x-1/2"></div>
        </div>

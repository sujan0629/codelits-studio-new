    ...
    >
      <div className="mx-auto max-w-5xl px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
          ...
          {/* Vertical divider */}
          <div className="hidden md:block absolute inset-y-0 left-1/2 w-[2px] bg-gray-600 rounded-full transform -translate-x-1/2"></div>
        ...
        {/* Horizontal divider */}
        <div className="w-full h-[2px] bg-gray-600 relative rounded-full">
          {/* Extend vertical through */}
          <div className="hidden md:block absolute top-0 bottom-0 left-1/2 w-[2px] bg-gray-600 rounded-full transform -translate-x-1/2"></div>
        </div>

        {/* Bottom single block */}
        <div className="feature grid grid-cols-1 md:grid-cols-2 gap-8 items-center  py-12">
          ...
          <div className="img aspect-[4/3] w-full relative rounded-lg overflow-hidden shadow-lg">
            <Image
              src="/images/ar.jpg"
              alt="Ideation"
              fill

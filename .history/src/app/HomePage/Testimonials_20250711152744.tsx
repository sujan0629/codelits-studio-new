...
const TestimonialCard = ({ testimonial }: { testimonial: typeof testimonials[0] }) => {
    ...
    return (
        ...
        >
            ...
            <div>
                <span className="text-6xl font-bold text-black leading-none select-none">
                    &quot;
                </span>
            </div>

            <p className="mt-2 text-base italic font-light text-muted-foreground leading-relaxed text-left">
                {testimonial.quote}
            </p>

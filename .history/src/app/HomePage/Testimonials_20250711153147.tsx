...
const TestimonialCard = ({ testimonial }: { testimonial: typeof testimonials[0] }) => {
    ...
    return (
        <div
            ref={cardRef}
            className="relative p-8 rounded-lg bg-white text-black shadow-lg flex-shrink-0 w-[540px] md:w-[580px] h-[360px] flex flex-col justify-between border border-border cursor-grab"

        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.slice(0, 2).map(({ title, description, imgSrc, imgAlt, Icon }, i) => (
              <div
                key={i}
             className={`feature space-y-4 text-left ${i === 1 ? 'pl-6 pr-6 md:pl-12 md:pr-12' : ''} flex flex-col`}

                style={{ minHeight: '100%' }} // try to stretch height
              >
                ...
                <div className="img mt-4 aspect-[4/3] w-full relative rounded-lg overflow-hidden shadow-lg bg-muted flex-grow">
                  <Image
                    src={imgSrc}
                    alt={imgAlt}
                    fill

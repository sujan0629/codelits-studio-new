...
function Hero() {
  ...
  const title = "Crafting Digital Brilliance for Visionary Startups and Leading Brands";
...
<h1 className="font-headline text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter max-w-[700px] md:max-w-[600px] lg:max-w-[500px] leading-tight">

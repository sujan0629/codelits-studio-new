...
function ProductDirection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-32 overflow-hidden bg-background">
      ...
      <div className="direction-image-container mt-20 md:mt-24 perspective-1000">
        <div
          className={cn(
            "relative max-w-6xl mx-auto aspect-[12/6] rounded-2xl",
            "[mask-image:radial-gradient(ellipse_100%_40%_at_50%_60%,black,transparent)]",
            "transform-gpu",
            "[transform:rotateX(20deg)_rotateZ(-2deg)]"
          )}
        >
          ...
          <Image
            ...
            width={1200}
            height={600}
            className="rounded-xl shadow-2xl w-full h-full object-cover object-center"

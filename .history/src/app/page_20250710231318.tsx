...
<div className="hero-image mt-24 relative max-w-[1150px] mx-auto group">
  ...
  <div className="rounded-xl border border-yellow-700 shadow-lg overflow-hidden bg-background">
    {/* Top nav bar */}
    <div className="flex items-center gap-2 px-4 h-8 bg-gray-900 rounded-t-xl">

...
const clients = [
  {
    name: 'Meta',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/6/6a/Meta_Platforms_Inc._white_logo.svg', // white logo
  },
  {
    name: 'Apple',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_white.svg', // white apple logo
  },
  {
    name: 'Amazon',
  ...
  {
    name: 'Google',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg', // colored "G" logo works on dark bg
  },
  {
    name: 'Microsoft',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg', // colored logo, can add white version below
  },
  {
    name: 'Microsoft (white)',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/3/36/Microsoft_Office_white_logo.svg',
  },
  {
    name: 'IBM',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/5/51/IBM_logo.svg', // white logo available, but this one works too
  },
  {
    name: 'Spotify',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/2/26/Spotify_logo_with_text.svg', // white or black variants available
  },
  {
    name: 'Twitter',
    logo: 'https://upload.wikimedia.org/wikipedia/en/6/60/Twitter_Logo_as_of_2021.svg', // blue bird logo
  },
  {
    name: 'Tesla',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/b/bd/Tesla_Motors.svg', // white logo variant not easily found, but black on light bg works
  },
];
...
function Hero() {
  ...
  const title = "Crafting Digital Brilliance";

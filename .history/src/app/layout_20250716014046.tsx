...
export const metadata: Metadata = {
  ...
  description: 'CodeLits Studio is a full-spectrum technology company delivering innovative solutions in software development, AI, mobile applications, web platforms, UI/UX design, and digital transformation for businesses worldwide.',
};

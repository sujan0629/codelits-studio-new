...
<div className="hero-image mt-24 relative max-w-[1150px] mx-auto group">
  ...
  <div className="rounded-xl border border-[#111111] shadow-lg overflow-hidden bg-background">
    ...
    <div className="flex items-center gap-2 px-4 h-8 bg-black/50 rounded-t-xl">
    ...
    <div className="relative aspect-[20/7.7]">
      ...
      <div className="absolute inset-0 rounded-b-xl bg-black opacity-30 pointer-events-none" />
    </div>
  </div>

...
<filter id="shadow" x="-40%" y="-30%" width="160%" height="160%">
  <feDropShadow dx="0" dy="6" stdDeviation="3" floodColor="#000" floodOpacity="0.25" />
</filter>
  ...
  />
          ...
          {/* Medal */}
          <g className="swing" filter="url(#shadow)">
            <circle
              className="shimmer"
              cx={150}
              cy={250}
...
/>
            ...
            <circle
              ...
              opacity={0.9}
            />
            <g stroke="#fff8c8" strokeOpacity={0.7} strokeWidth={1.5} strokeLinecap="round">

          ...
          <NavigationMenuList className="flex gap-4 text-sm font-medium items-center">
            ...
            <NavigationMenuItem>
              <NavigationMenuLink asChild>
                <Link href="/process">
                  <a className="nav-click-anim">Process</a>
                </Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
            ...
            <NavigationMenuItem>
              <NavigationMenuLink asChild>
                <Link href="/blog">
                  <a className="nav-click-anim">Blog</a>
                </Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
            ...
            <NavigationMenuItem>
              <NavigationMenuLink asChild>
                <Link href="/team">
                  <a className="nav-click-anim">About Us</a>
                </Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
          </NavigationMenuList>
...
// ListItem Component - wraps internal hrefs with Link to avoid nested <a>

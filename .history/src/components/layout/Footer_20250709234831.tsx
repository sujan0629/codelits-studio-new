      ...
      <div className="container relative mx-auto max-w-screen-2xl px-4 py-12">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
          ...
          <img src="/logos/logo.png" alt="CodeLits Studio Logo" className="h-36 w-36 object-contain" />
            ...
            <h5 className="mt-1 max-w-xs text-muted-foreground">
              CodeLits Studio Pvt. Ltd.® <br />
              <p className="text-xs mt-2">Crafting exceptional digital experiences for a modern world.</p>
            </h5>

...
/>
  ...
  size="icon"
  variant="ghost"
  className="border-none bg-background/50 backdrop-blur-sm rounded-full w-12 h-12 group-hover:scale-110 group-hover:bg-primary/10 transition-transform flex-shrink-0 mt-4 self-end"
  aria-label={`Learn more about ${feature.title}`}
>
  <Plus className="w-6 h-6" />
</Button>

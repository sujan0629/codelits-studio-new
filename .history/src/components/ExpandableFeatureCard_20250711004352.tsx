  ...
  return (
    <>
      <div
        ...
        className="relative group col-span-1 flex flex-col rounded-2xl border border-border/50 bg-card/60 cursor-pointer overflow-hidden shadow-lg  hover:border-primary/30 transition-all duration-300 h-full"
      >
        ...
        <div className="p-6 flex-grow flex flex-col items-start justify-between">
            ...
            <Button
                size="icon"
                variant="outline"
                className="bg-background/50 backdrop-blur-sm rounded-full w-12 h-12 group-hover:scale-110 group-hover:bg-primary/10 transition-transform flex-shrink-0 mt-4 self-end"
        ...
        <SheetContent side="bottom" className="h-[90vh] max-w-2xl mx-auto bg-card/80 backdrop-blur-xl border-t border-primary/20 rounded-t-2xl p-0">
            <ScrollArea className="h-full w-full">
                <div className="p-8 md:p-12">
                     <div className="relative w-full h-64 md:h-80 rounded-xl overflow-hidden mb-8 md:mb-12 shadow-2xl shadow-primary/10">
                         <Image
                            src={feature.image}
                            alt={feature.title}
                            fill

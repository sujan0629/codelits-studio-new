    ...
    <div className="mt-24 bg-card p-8 md:p-12 rounded-2xl">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          {/* Wrapper forcing left alignment, bigger height and spacing */}
          <div
            className="mt-10"  // bigger top margin for spacing below paragraph
            style={{
              maxWidth: '220px',
              textAlign: 'left',
              marginLeft: 0,    // push fully left inside container
              paddingLeft: 0,
            }}
          >
            <div
              ...
              data-style-height="80px"  // increased height

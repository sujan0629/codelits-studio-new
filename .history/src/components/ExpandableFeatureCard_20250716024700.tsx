...
/>
  ...
  <div className="flex items-center justify-between">
    ...
    <Button
      variant="ghost"
      className="border-none bg-background/50 backdrop-blur-sm rounded-full w-12 h-12 group-hover:scale-110 group-hover:bg-primary/10 transition-transform flex-shrink-0"
...
>
  Learn More About Our Process <ArrowRight className="ml-2" />
</Button>

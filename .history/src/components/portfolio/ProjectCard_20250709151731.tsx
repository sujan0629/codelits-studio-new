...
<div className={cn(
  ...
  <div className="relative w-16 h-16 mb-4">
    {/* Orbiting atoms */}
    <span className="absolute w-2 h-2 bg-yellow-400 rounded-full animate-orbit1 shadow-[0_0_8px_#FFD700]" />
    <span className="absolute w-2 h-2 bg-yellow-500 rounded-full animate-orbit2 shadow-[0_0_8px_#FFC107]" />
    <span className="absolute w-2 h-2 bg-yellow-300 rounded-full animate-orbit3 shadow-[0_0_8px_#FFEB3B]" />
    {/* Center nucleus */}
    <span className="absolute top-1/2 left-1/2 w-3 h-3 bg-yellow-200 rounded-full transform -translate-x-1/2 -translate-y-1/2 shadow-[0_0_10px_#FFD700]" />
  </div>

...
return (
  <div ref={sectionRef} className="w-full mt-28 mb-20 py-8 flex justify-center">
    <div className="flex flex-col md:flex-row items-center md:gap-8 gap-4">
      <h2 className="animate-item text-lg md:text-3xl font-semibold text-center md:text-left max-w-lg">

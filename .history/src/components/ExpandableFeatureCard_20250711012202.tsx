...
/>
  ...
  <Button
    variant="ghost"
    className="border-none bg-background/50 backdrop-blur-sm rounded-full w-14 h-14 group-hover:scale-110 group-hover:bg-primary/10 transition-transform flex-shrink-0"
    aria-label={`Learn more about ${feature.title}`}
  >
    <Plus className="w-8 h-8" />
  </Button>
  <h3 className="mt-4 font-headline text-2xl font-bold text-center">{feature.title}</h3>
</div>

...
export function ExpandableFeatureCard({ feature }: { feature: Feature }) {
  ...
  return (
    <>
      ...
      >
 <div className="relative w-full h-48 overflow-hidden shadow-none">
  <Image
    src={feature.image}
    alt={feature.title}
    fill
    className="object-cover group-hover:scale-105 transition-transform duration-300 shadow-none"
  />
</div>

...
>
 ...
 <button
  ...
  aria-label="Close"
  className="absolute right-4 top-4 rounded-full bg-background/50 backdrop-blur-sm transition-colors hover:bg-background w-14 h-14 flex items-center justify-center"
>
  <X className="h-10 w-10 drop-shadow-none filter-none" />
</button>

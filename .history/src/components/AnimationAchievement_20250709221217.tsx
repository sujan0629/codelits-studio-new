  ...
  return (
    <>
      <style>{`
        ...
        /* Replace black shadow with golden glow */
        .glow {
      ...
      <div
        className="container"
        role="img"
        aria-label="Gold medal with glowing shimmer"
        style={{ overflow: "visible", width: 220, height: 308, margin: "auto" }}
      >
        <svg
          viewBox="0 0 300 420"
        ...
        >
          ...
          {/* Medal without black shadow, but golden glow instead */}
          <g className="swing glow">
            <circle
              className="shimmer"
              cx={150}
              cy={250}

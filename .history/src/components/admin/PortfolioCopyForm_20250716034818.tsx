    ...
    return (
        <div className="space-y-10">
            ...
            <div className="space-y-1">
                <h2 className="font-headline text-lg font-semibold">Project Details</h2> {/* was text-2xl -> now text-lg */}
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-sm">Project Description</FormLabel> {/* added text-sm */}
                                <FormControl>
                                    <Textarea
                                        placeholder="Describe the project, its goals, and the final outcome."
                                        {...field}
                                        className="min-h-[100px] text-sm" // added text-sm here
                                    />
                                </FormControl>

        ...
        <div className="space-y-10">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    />
                   <Button type="submit" disabled={loading} className="w-40 mx-auto" size="lg">
    {loading ? (
        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
    ) : (
        <Sparkles className="mr-1 h-2 w-4" />
    )}
            ...
            {suggestion && (
                <div className="mt-10 space-y-6">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm bg-primary/5 p-4 rounded-lg border border-border">{suggestion.suggestedTitle}</p>
                    </div>
                    <div className="space-y-2">

  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative w-16 h-16 mb-4">
        ...
        <span className="absolute w-2 h-2 bg-white rounded-full shadow-[0_0_8px_#FFC107] orbit2" />
        <span className="absolute w-2 h-2 bg-white rounded-full shadow-[0_0_8px_#FFEB3B] orbit3" />
        {/* Center nucleus */}
        <span className="absolute top-1/2 left-1/2 w-3 h-3 bg-yellow-500 rounded-full shadow-[0_0_10px_#FFD700] -translate-x-1/2 -translate-y-1/2" />
      </div>

      <p className="text-white font-normal text-base animate-pulse">Loading..</p>

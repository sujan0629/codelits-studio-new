        ...
        <Card className="relative flex flex-col overflow-hidden transition-all duration-300 bg-card border-2 border-border/50 h-full">
          <CardContent className="p-0 relative aspect-[4/3]">
             ...
             <iframe
                src={project.link}
                title={project.title}
                className="absolute inset-0 w-full h-full border-0 transition-opacity duration-500 opacity-0"
                loading="lazy"
            ...
            <div className="absolute bottom-0 left-0 p-6 w-full transition-all duration-500 transform group-hover:translate-y-0 translate-y-12">
               ...
               <p className="text-sm text-white/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 [text-shadow:0_1px_2px_rgba(0,0,0,0.4)]">{project.description}</p>
            </div>

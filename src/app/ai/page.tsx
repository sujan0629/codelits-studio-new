  ...
  return (
    <div className="relative overflow-hidden bg-dark text-foreground min-h-screen ">
      ...
      <section className="py-20 md:py-28 max-w-3xl mx-auto px-4 text-center relative ">
        ...
        {/* Step 2: Bottom left */}
<div
  className="absolute bottom-12 left-[100%]  w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <Check className="w-6 h-6 text-primary" />
...
{/* Step 3: Bottom right */}
<div
  className="absolute bottom-12 right-[100%] w-40 sm:w-44 px-4 py-2 rounded-md border border-primary/30 bg-white/5 backdrop-blur flex items-center gap-2"
  style={{ backdropFilter: 'blur(8px)' }}
>
  <Check className="w-6 h-6 text-primary" />
